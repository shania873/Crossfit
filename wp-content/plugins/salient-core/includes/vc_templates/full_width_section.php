<?php
  ...
  echo'<div id="'.uniqid("fws_").'" class="wpb_row vc_row-fluid '. $main_class . $equal_height_class . $parallax_class . ' ' . $vertically_center_class . ' ' . $class . ' " '.$using_custom_text_color.' style="'.$style.'">';
