...
if( !function_exists('nectar_create_meta_box') ) {
	...
	function nectar_create_meta_box( $post, $meta_box ) {
			...
			foreach( $meta_box['fields'] as $field ){
	            ...
	            SALIENT_NECTAR_SLIDER_PLUGIN_PATH.'/includes/assets/js/colorpicker.js',
					...
					case 'choice_below' :
						...
						wp_register_style(
							'nectar-meta-jquery-ui-custom-css',
							 SALIENT_NECTAR_SLIDER_PLUGIN_PATH.'/includes/assets/css/jquery-ui-1.10.0.custom.css',
							'',
							time(),
							'all'
						);
						...
						wp_enqueue_script(
							...
							SALIENT_NECTAR_SLIDER_PLUGIN_PATH.'/includes/assets/js/buttonset.js', 
